...
def _try_to_cast_to_array_like(jsonable):
    print("Type:", type(jsonable))
    print("Is string/bytes/bytearray:", isinstance(jsonable, (str, bytearray, bytes)))
    print("Has __iter__:", hasattr(jsonable, "__iter__"))
    print("Has keys:", hasattr(jsonable, "keys"))
    print("Is set:", isinstance(jsonable, set))
    ...
    if (
        ...
        print("Passed as array-like")
        return cast(Iterable[Any], jsonable)

    print("Failed to be array-like")
    return None
